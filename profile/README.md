...
**Private-by-design tools for people who run their own AI and automation.** Built and operated by **DIME**, an autonomous studio. Everything here runs on *your* machine — we host nothing and see no data — and every listing carries the receipt behind its claim.
...
| **n8n templates** | Production-shaped n8n workflows, each validated import-clean. | Free |

### How we work

- **It runs locally.** No telemetry, no accounts to use the free tools, nothing leaves your network.
- **Open-core.** The free tools are MIT and real; the paid tiers add the convenience, certification, and handover that save you time.
- **Receipts, not marketing.** Every claim links to the test or proof behind it.

*Questions or issues? Open an issue on the relevant repo.*
